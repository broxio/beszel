...
import { duckFaviconDataUri } from "./favicon-duck"
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
  <image width="128" height="128" href="${duckFaviconDataUri}"/>
  ${downCount > 0
				? `
		<circle cx="96" cy="96" r="30" fill="#f00"/>
  	<text x="96" y="110" font-size="44" text-anchor="middle" fill="#fff" font-family="Arial" font-weight="bold">${downCount}</text>
	`
				: ""
			}
</svg>
